# work-bootstrap — CLAUDE.md Template

Disclosed reference for [`work-bootstrap`](SKILL.md). The exact final content for a missing root `CLAUDE.md`.

## CLAUDE.md Template

Use this exact template for a missing root `CLAUDE.md`. When appending to an existing `CLAUDE.md`, omit the `# CLAUDE.md` heading and append the remaining content after a blank line.
